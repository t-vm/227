...
func f1_(): #对话函数1（开头cg）
	Dialogbox.show_dialogbox([{name='',text='如果你可以听到  打起精神，死亡不是一切的终点。'},{name='在梦中的世界沿着向前延伸的路走下去，崭新的世界在等待着你。',text=''},{name='幸福',text=''},{name='快乐',text=''},{name='共感',text=''},{name='认同',text=''},{name='',text='也许你可以拥有你想要的一切'}])
...
func f11_(): #对话函数11（第一关， 车厢里，和途径站标识板互动，第1个可交互式对话框）
...
func f12_(): #对话函数12（第一关，车厢里，与海报1互动，第2个可交互对话框）
...
func f15_(): #对话函数15（第一关，车厢里，与海报2互动，第3个可交互对话框）
